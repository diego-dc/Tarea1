...
def simulador_en_mov():
     ...
     nubes.DrawMoving_x(pipeline, pipelineTexture, dt)
     avion.draw(pipeline)
     panel.draw(pipeline)
...
def simulador_quieto():
     ...
     pastito.draw(pipeline)
     nubes.draw(pipeline, pipelineTexture)
     avion.draw(pipeline)
     panel.draw(pipeline)
     indicadores.draw(pipeline)
     perillas.draw(pipeline)
...
def simulador_elevar_descender():
    if avion.despegar:
        ...
        pastito.draw(pipeline)
        nubes.DrawMovingDown_x_y(pipeline, pipelineTexture, dt)
        avion.draw(pipeline)
        panel.draw(pipeline)
        indicadores.draw(pipeline)
        perillas.draw(pipeline)
    ...
    if avion.aterrizar or avion.caida_libre:
        ...
        pastito.draw(pipeline)
        nubes.DrawMovingUp_x_y(pipeline, pipelineTexture, dt)
        avion.draw(pipeline)
        panel.draw(pipeline)
        indicadores.draw(pipeline)
        perillas.draw(pipeline)
